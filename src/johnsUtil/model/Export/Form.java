...
public class Form {
    ...
    public String getTypeofAppInfo() {
        return typeofAppInfo;
    }

    public void setTypeofAppInfo(String typeofAppInfo) {
        this.typeofAppInfo = typeofAppInfo;
    }
