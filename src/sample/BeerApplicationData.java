...
public class BeerApplicationData extends ApplicationData{
     ...
     */
    public BeerApplicationData(String ttbID, int repid, String serial, String address, String permitNo, String phoneNumber, String email, String applicantName, int type1, String type2, int type3, java.sql.Date submittedDate) {
