...
public class dataUtilUpload {
    ...
    private String ALCOHOL_FIELDS = " (AID, NAME, APPELLATION, SULFITE_DESC, ALCH_CONTENT, HEALTH_WARNING, PRODUCT_TYPE, CLASS, LABEL_LEGIBILLITY, LABEL_SIZE, FORMULAS, ALCOHOL_TYPE, BOTTLERS_INFO, BRAND_NAME, STATUS, WINE_VINTAGE, PH_LEVEL, GRAPE_VARIETAL, INFO_ON_BOTTLE, SOURCE_OF_PRODUCT, DATE_APPROVED, ORIGIN_CODE, NET_CONTENT)";
    private String CLASS_FIELDS = " (CID, CLASS)";
    private String NEW_FORM_FIELD = "FID, TTBID, REPID, SERIAL, ADDRESS, PHONE, EMAIL, APPLICANTNAME, STATUS, AID, APP_TYPE_1, APP_TYPE_2, APP_TYPE_3, DATE_SUBMITTED, PERMIT_NAME, PERMIT_ADDRESS, QUALIFICATIONS, RECEIVED_CODE, SPECIAL_WORDING_DESCRIPTION, PERMITNO";
    private String FORM_FIELDS = " (FID, TTBID, REPID, SERIAL, ADDRESS, PHONE, EMAIL, APPLICANTNAME, STATUS, AID, APP_TYPE_1, APP_TYPE_2, APP_TYPE_3, DATE_SUBMITTED, PERMIT_NAME, PERMIT_ADDRESS, QUALIFICATIONS, RECEIVED_CODE, SPECIAL_WORDING_DESCRIPTION, PERMITNO)";
     ...
     */
    @Deprecated
    public dataUtilUpload(AccountsUtil accounts, ScreenUtil screen){
        conn = connect();
        //screenUtil = screen;
    ...
    public int addAlcohol(String name, String appellation, String sulfiteDesc, double alcoholContent, String netContent, String healthWarning, int productType, int classType, String labelLegibility, String labelSize, String formulas, int alcoholType, String bottlersInfo, String brandName, String status, int wineVintage, double phLevel, String grapeVarietal, String infoOnBottle, String sourceOfProduct, java.sql.Date dateApproved, int originCode) throws SQLException {
        //System.out.println(ALCOHOL_FIELDS);

        String values = "'" + name + "', '" + appellation + "', '" + sulfiteDesc + "', " + alcoholContent + ",'" + healthWarning + "', " + productType + ", " + classType + ", '" + labelLegibility + "', '" + labelSize + "', '" + formulas + "', " + alcoholType + ", '" + bottlersInfo + "', '" + brandName + "', '" + status + "', " + wineVintage + ", " + phLevel + ", '" + grapeVarietal  + "', '" + infoOnBottle + "', '" + sourceOfProduct + "', " + "'" + dateApproved.toString() + "'" + ", " + originCode + ",'" + netContent + "')";
    ...
    public String addForm(String ttbid, int repid, String serial, String address, String phone,
                          String email, String applicantName, String status, int appType1, String appType2,
                          int appType3, java.sql.Date dateSubmitted, String PERMIT_NAME, String PERMIT_ADDRESS, String QUALIFICATIONS,
                          String RECIEVED_CODE, String SPECIAL_WORDING_DESCRIPTION, String permitNo) throws SQLException{
        ...
        rset = stmt.executeQuery("SELECT FID FROM FORM ORDER BY FID DESC");

        // checks if table is empty. adds one to previous row's ID for new o+ne if it is not empty. sets ID = 1 if it is
        if (rset.next()) {
            ID = rset.getInt("FID") + 1;
        } else {
            ID = 1;
        }

        uRows = stmt.executeUpdate("INSERT INTO FORM (FID, TTBID, REPID, SERIAL, ADDRESS, " +
                "PHONE, EMAIL, APPLICANTNAME, STATUS, AID, " +
                "APP_TYPE_1, APP_TYPE_2, APP_TYPE_3, DATE_SUBMITTED, PERMIT_NAME, " +
                "PERMIT_ADDRESS, QUALIFICATIONS, RECEIVED_CODE, SPECIAL_WORDING_DESCRIPTION, PERMITNO) VALUES (" +
                "" + ID + ",'" + ttbid + "', " + repid + ", '" + serial + "', '" + address + "', " +
                "'" + phone + "', '" + email + "', '" + applicantName + "', '" + status + "', 6, " +
                "" + appType1 + ", '" + appType2 + "', " + appType3 + ", '" + dateSubmitted + "','" + PERMIT_NAME + "'," +
                "'" + PERMIT_ADDRESS  + "','" + QUALIFICATIONS  + "','" + RECIEVED_CODE  + "','" + SPECIAL_WORDING_DESCRIPTION  + "', '" + permitNo + "')");
   ...
   /* public String addWineForm(String ttbid, int repid, String serial, String address, String formula, String grapeVar, String appellation, int permit_no, String infoOnBottle, String source_of_product,
    ...
    private int addToTable(String TABLENAME, String FIELDS, String values, String IDNAME) throws SQLException {
        ...
        int uRows = 0;
        stmt = conn.createStatement();
        System.out.println("SELECT * FROM " + TABLENAME + " ORDER BY " + IDNAME + " DESC");
        rset = stmt.executeQuery("SELECT "+ IDNAME + " FROM " + TABLENAME + " ORDER BY " + IDNAME + " DESC");
    ...
    */
    ...
    public ArrayList<ApplicationData> searchForm(String query) throws SQLException{
        ...
        while(rset.next()){
            ...
            a = new ApplicationData(ttbid, repid, serial, address, permit_no, phone_number, email, applicantName, type1, type2, type3,"", dateSubmitted);
            AppDataList.add(a);
        }
...
*/
    ...
    public ApplicationData fillSubmittedForm(String ttbid) throws SQLException{
        ...
        a = new ApplicationData(ttbid, repid, serial, address, permit_no, phone_number, email, applicantName, type1, type2, type3,"", d);
...
*/
    ...
    public int updateFormSubmission(ApplicationData applicationData, AlcoholData alcoholData) throws SQLException{
        ...
        sm.setString(13, applicationData.getTtbID());
